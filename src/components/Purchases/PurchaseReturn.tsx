...
const PurchaseReturn = () => {
  ...
  return (
    <div className="bg-[#f9fafc] min-h-full px-2 py-2 md:px-2">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
        <div className="pr-10 md:pr-0">
          <h1 className="text-xl sm:text-2xl primary-font text-gray-900">Purchase Return</h1>
          <p className="text-sm light-font text-gray-500 mt-0.5">
            Manage returns of purchased goods to your suppliers
          </p>
        </div>
        <Button
